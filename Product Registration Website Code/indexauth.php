...
<title>Amazon DRS Registration</title>
	...
	<div id="wrapper2">
		<div id="header" class="container">
			<div id="logo">
				...
				<!--<img src="amazon-dash-replenishment-service-thumb-400.jpg" width="300" height="100">-->
		...
		<!-- end #header -->
      <h5><script language="javascript">document.write(this_date_string); </script></h5>
      <div id="page">
			<div id="content">
				<div class="post">
					<h2><p align="center">Authorization Code:</p></h2>
					<?php  
					$authcode = $_GET["code"]; 
					echo $authcode; 
					?>
...
<div style="clear: both;">&nbsp;</div>
	    ...
	    <h4>
          ...
          Product ID :    
            <input type="text" name="textfield" value="c0286393-3360-48d0-94ea-eae22b6acfea" id="productid" /> </h4>
<h4>
  
  
  Serial No. : <input type="text" name="textfield2" id="serialno" /></h4>
<input type="button" name="button" id="button" value="Login with Amazon" style="text-align: center;" onClick="lwaFunction()" />
		</div>
		<!-- end #page -->
	</div>
</div>
